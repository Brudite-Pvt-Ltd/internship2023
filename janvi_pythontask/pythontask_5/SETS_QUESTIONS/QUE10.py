#10.You are given a set of positive integers.
#Write a function to find the length of the longest consecutive sequence of numbers that can be formed by arranging the elements in any order.
