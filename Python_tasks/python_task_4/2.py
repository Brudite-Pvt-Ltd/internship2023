# question 2 :  fetching all the candidates having more then experience 5
...
# using filter to find the experience > 5 

experienced_engineering = list( filter(lambda x : x[1][1] > 5 , candidate ) )
for x in experienced_engineering:
    print(x)