# question 3 : candidates with pin = 302012
...
# filtering the data based on there pin code

candidate_with_pin = list( filter(lambda x : x[1][3] == "302012" , candidate))
for x in candidate_with_pin :
    print(x)
