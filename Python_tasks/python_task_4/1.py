# question 1 :  fetching all the roles
...
# using filter to filter the data with there designation.


# software engineer
se =   list( filter(lambda x: x[1][0] == 'Manager'  , candidate))
...
# manger
me =   list( filter(lambda x: x[1][0] == 'Software Engineer'  , candidate))
print("Mangers : ")
for x in me:
    print(x)
print()
...
# team lead
tl =   list( filter(lambda x: x[1][0] == 'Team Lead'  , candidate))
print("Team Lead : ")
for x in tl :
    print(x)
print()
...
# associate dev
ad =   list( filter(lambda x: x[1][0] == 'Associate Developer'  , candidate))
print("Associate Devoper : ")
for x in ad :
    print(x)
print()
