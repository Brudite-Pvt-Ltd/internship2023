...
updated_email=lambda x: (x[0], [x[1][0], x[1][1], x[1][2].replace("@","@brudite"), x[1][3], x[1][4]])
candidate_with_company_domain_name= list(map(updated_email,candidate))
print(candidate_with_company_domain_name)